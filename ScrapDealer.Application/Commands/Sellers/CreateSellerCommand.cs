...
namespace ScrapDealer.Application.Commands.Sellers
{
    public record CreateSellerCommand(string FirstName, string LastName, string NationalCode, string City, string Province,
        string? PostalCode, string AddressDescription, string? Email, PersonType PersonType, Gender Gender, Guid UserId, Guid? NationalCardFileId, Guid? ProfileFormFileId,
        double? Latitude = null, double? Longitude = null) : ICommand;
}